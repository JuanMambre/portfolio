...
const Projects = () => {
  const projects = [
    ...
    },
    {
      id: 3,
      src: pifood,
      link: 'https://www.linkedin.com/posts/juan-cruz-mambretti-a8a3a9281_comunidad-estoy-emocionado-y-feliz-de-compartir-activity-7090797188934443008-C3J2?utm_source=share&utm_medium=member_desktop',
      gitHub: 'https://github.com/JuanMambre/Pi-food-juan'
    },
  ];
        ...
        <div className=' grid sm:grid-cols-2 md:grid-cols-3 gap-8 px-12 sm:px-0'>
          {projects.map(({ id, src, link, gitHub, deploy }) => (
            <div key={id} className=' shadow-md shadow-gray-600 rounded-lg overflow-hidden '>
              <img src={src} alt="" className=' rounded-md duration-200 hover:scale-105 max-h-25 w-full object-cover'/>
              <div className=' flex justify-between px-5 py-5'>
                <button onClick={() => window.location.href = link}>Demo</button>
                <button onClick={() => window.location.href = gitHub}>Code</button>
